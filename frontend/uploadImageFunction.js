...
export const uploadImage = async (image, bucketName, userId = null) => {
  ...
  // if (bucketName === "profile" && userId) {
  //   formData.append("public_id", profile_images/${userId});
  //   formData.append("overwrite", "true"); // ensures Cloudinary replaces the existing image
  // }
