      ...
      <div className="flex flex-col gap-5 border-l-1 pl-10 border-gray-400 py-4">
        ...
        {/* <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-4">
            {sizesArray.map((element, index) => {
              return (
                <div
                  key={index}
                  onClick={() =>
                    setProductDetails({ ...productDetails, size: element })
                  }
                  className={`h-11 w-11 border-2 flex justify-center items-center bg-gray-100  cursor-pointer ${
                    productDetails.size === element
                      ? "border-amber-400"
                      : "border-gray-200"
                  }`}
                >
